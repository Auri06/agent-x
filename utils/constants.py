...
class Assets:
    ...
    # * Enemigos
    DOWN1: Path = Path("assets/images/enemies/DOWN_1.png")
    DOWN2: Path = Path("assets/images/enemies/DOWN_2.png")
    DOWN3: Path = Path("assets/images/enemies/DOWN_3.png")
    DOWN4: Path = Path("assets/images/enemies/DOWN_4.png")

    UP1: Path = Path("assets/images/enemies/UP_1.png")
    UP2: Path = Path("assets/images/enemies/UP_2.png")
    UP3: Path = Path("assets/images/enemies/UP_3.png")
    UP4: Path = Path("assets/images/enemies/UP_4.png")

    WALK1: Path = Path("assets/images/enemies/WHALK_1.png")
    WALK2: Path = Path("assets/images/enemies/WHALK_2.png")
    WALK3: Path = Path("assets/images/enemies/WHALK_3.png")
    WALK4: Path = Path("assets/images/enemies/WHALK_4.png")
    ...
    # * Bloques
    TILES = Path("assets/images/tiles/block.png")
    # * Otros
